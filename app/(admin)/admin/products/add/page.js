...
import { Plus, X, Upload, Trash2, ChevronDown, DollarSign } from 'lucide-react';
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-200 p-6 md:p-10">
        <form className="space-y-10" onSubmit={handleSubmit}>
          ...
          <div className="pt-10 flex flex-col md:flex-row gap-4 border-t border-gray-100">
            <button disabled={saving} type="submit" className="flex-[2] py-5 bg-indigo-600 text-white rounded-2xl font-bold uppercase tracking-[0.2em] text-sm hover:bg-indigo-700 shadow-xl shadow-indigo-100 transition-all active:scale-[0.98] disabled:opacity-70">
