...
function Featured() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await fetch("/api/products?isFeatured=true&limit=4", { cache: "no-store" });
    ...
    <>
      <div className='mt-8 mb-6'>
        <div className='flex items-center justify-between'>
          <h2 className='text-2xl lg:text-3xl font-bold text-gray-900 tracking-tight'>Featured Products</h2>
        </div>
